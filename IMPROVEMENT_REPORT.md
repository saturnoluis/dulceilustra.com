...
- dulceilustra\_\_contacto.gif: 344KB
- dulceilustra\_\_firma.png (logo, every page): 272KB
- dulceilustra\_\_estrellas.png: 152KB
...
### 3. Add SEO meta tags to main.html template
...
- Canonical URL: `<link rel="canonical" href="{{ site.url }}{{ page.url }}" />`
  **Note:** Site data file (`_content/_data/site.js`) already exists
...
### 5. Add JSON-LD structured data for Person schema
...
### 6. Update content frontmatter with SEO metadata
...
### 7. Optimize home_animation.mp4 video file
...
### 8. Convert contact GIF to video format
...
### 9. Convert logo and large PNGs to WebP format
...
### 10. Standardize gallery images to WebP format
...
### 11. Extract carousel JavaScript to external file
...
### 12. Extract prefetch script to external file

**Current state:** Prefetch script inline in `_includes/layouts/main.html`
**Action:** Similar to item 11, extract to `_includes/js/prefetch.js` and reference externally.
**Benefits:** Better caching, consistent with other JS files

### 13. Create reusable bilingual heading component
...
### 14. Consolidate duplicate social media CSS
...
### 15. Optimize Google Fonts loading
...
<link
    href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;600&family=Staatliches&display=swap"
    rel="stylesheet"
/>
```
...
### 16. Add resource hints for critical assets
...
### 17. Add CSS minification to build process
...
### 19. Update robots.txt for production
...
**Critical:** Only do this after items 1, 3-6 are complete (SEO foundation in place)

### 20. Add RSS feed for gallery updates
...
### 21. Improve gallery item metadata
...
### 22. Clean up duplicate gallery items
...
### 23. Create automated image optimization pipeline
...
### 25. Extract header and footer into separate components
...
### 26. Add dynamic language attribute
...
**Note:** Frontmatter already should have `lang: "es"` in most pages (verify as part of item 6)

### 27. Add favicon references
...
### 28. Self-host Google Fonts (advanced performance optimization)
...
**Alternative:** Keep using Google Fonts CDN if simplicity preferred (item 15 already optimizes the loading)
...
2. Add SEO meta tags (items 3-6)
3. Optimize large media files (items 7-9)

**Quick Wins (< 30 minutes each):**

- Items 2, 3, 4, 5, 16, 17, 18

**High Impact Items:**

- Items 1, 3, 4, 7, 8, 9, 14, 15, 18
...
- Items 17, 18, 20, 23, 24

**Before Launch Checklist:**

- Complete items 1, 3-6 (SEO foundation)
- Complete items 7-9 (major file size reduction)
- Complete item 19 (update robots.txt)
...
_This document is intended for AI agent consumption. Each numbered item is a discrete, actionable task that can be implemented independently (unless dependencies are noted). Remove completed items and renumber remaining items._
